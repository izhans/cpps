...
int main()
{
	...
	try
	{
		AForm form("ImportantForm", 50, 100);
	...
	try
	{
		AForm tooHigh("TooHighForm", 0, 50);
	...
	try
	{
		AForm tooLow("TooLowForm", 151, 50);
	...
	try
	{
		AForm tooHighExec("TooHighExec", 50, 0);
	...
	try
	{
		AForm tooLowExec("TooLowExec", 50, 151);
	...
	{
		Bureaucrat alice("Alice", 25);
		AForm form("AlreadySigned", 50, 100);
	...
	try
	{
		...
		AForm form("BoundaryForm", 50, 100);
